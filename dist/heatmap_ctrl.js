System.register(["./leaflet/leaflet.js", "./leaflet/leaflet-heat.js", "moment", "app/core/app_events", "app/plugins/sdk", "./leaflet/leaflet.css!", "./partials/module.css!"], function (_export, _context) {
  ...
  var L, heatLayer, moment, appEvents, MetricsPanelCtrl, panelDefaults, HeatMapCtrl;
      ...
      function (_MetricsPanelCtrl) {
        ...
        _createClass(HeatMapCtrl, [{
          ...
          value: function onInitEditMode() {
            log("onInitEditMode");
            this.addEditorTab('Options', 'public/plugins/grafana-heatmap-panel/partials/options.html', 2);
          }
        }, {
          key: "onPanelTeardown",
          ...
          value: function setupMap() {
            ...
            this.leafMap = L.map('heatmap-' + this.panel.id, {
          ...
          value: function onDataReceived(data) {
            ...
            var gridsquaresize_lat = 0.00007;
            var gridsquaresize_lon = 0.0001;
            ...
            for (var i = 0; i < values_grid.length; i++) {
              for (var j = 0; j < values_grid[i].length; j++) {
                ...
                if (allvalues !== undefined) {
                  ...
                  heatspots.push([grid_latlon.lat, grid_latlon.lon, avg.toString()]);
                }
              }
            }

            heatspots = heatspots.map(function (p) {
              return [p[0], p[1]];
            }); // var heat = L.heatLayer(heatspots).addTo(this.leafMap);      

            this.heat.setLatLngs(heatspots);
            this.addDataToMap();
          }
        }, {
